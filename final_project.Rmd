...
For the classification tree, we'll use `stroke` as our response variable and all other variables (excluding for `id`) as our predictors. However, before we begin, notice that there appears to be a large imbalance for this classification.
